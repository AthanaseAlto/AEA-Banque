...
while True:
    ...
    match choix:
        case 1:
            ...
            localisation = input("Entrer votre localisation: ")
            email = input("Email : ")
            ...
            compte = banque.creer_compte(nom,prenom,age,localisation,email,pwd,solde)
                ...
                while True:
                    ...
                    match choix_clt:
                        ...
                        case 2:
                            ...
                            connecte_compte.deposer(montant )
                        case 3:
                            montant = int(input("Montant : "))
                            connecte_compte.retirer(montant)
                        case 4:
                            banque.afficher_tous_les_comptes()
                            num_dest = input("Numéro du compte destinataire : ")
                            montant = int(input("Montant à transférer : "))
                            pwd = input("Confirmez votre mot de passe : ")
                            banque.transfert(
                                connecte_compte.client.num_clt,
                                num_dest,
                                montant,
                                pwd
                            )
